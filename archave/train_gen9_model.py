...
def train_model(cutoff_date=None, target_symbol=None):
    ...
    # 1. SETUP
    # Load the list of symbols: Either the specific target or the full dynamic watchlist
    symbols = [target_symbol] if target_symbol else cfg.WATCHLIST
