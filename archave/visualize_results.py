...
def plot_equity_curves():
    ...
    print(f"✅ Equity Curve comparison chart saved to: {equity_path}")
    plt.close()
...
def visualize_latest_backtest_results():
    ...
    print(f"✅ Sharpe Ratio chart saved to: {sharpe_path}")
    plt.close()
    ...
    print(f"✅ Max Drawdown chart saved to: {drawdown_path}")
    plt.close()
