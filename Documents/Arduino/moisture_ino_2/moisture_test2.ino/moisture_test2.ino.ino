...
long int sum1= 0, sum2 = 0, sum3 = 0, sensor1 = 0, sensor2 = 0 ;
...
void loop(){
  ...
  sensor1 = map(sum1/N_AVERAGE, WaterValue, AirValue, 0, 100);
    // moisture sensor V1.0
  sensor2 = map(sum3/N_AVERAGE, 1023, AirValue, 0, 100);
  Serial.print( counter);
  Serial.print(": Moisture Sensor Value:");
  Serial.print(sum1/N_AVERAGE + "," + sensor1);
  Serial.print(": Moisture Sensor 2 Value:");
  Serial.print(sum3/N_AVERAGE + "," + sensor1);
