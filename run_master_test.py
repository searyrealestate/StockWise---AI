...
def run_backtest():
    ...
    print("--- 🚀 Starting Full System Performance Backtest (long mode) ---")
    ...
    if process.returncode != 0:
        print("--- ❌ Backtest script failed with an error ---")
        return False

    print("--- ✅ Backtest script completed successfully ---")
    return True


def archive_results(tab_name):
    """Reads the latest summary and appends it to the master Excel file."""
    print(f"--- 🗄️ Archiving results to sheet: {tab_name} ---")
    ...
    try:
        ...
        print(f"--- ✅ Results successfully archived in '{MASTER_RESULTS_FILE}' ---")

    except FileNotFoundError:
        print(f"--- ❌ ERROR: Summary file not found at '{SUMMARY_INPUT_FILE}'. Archiving failed. ---")
