...
TEMPLATE_GENERATION_RECIPES = {
    ...
    "2H_RESISTANCE_BREAKOUT": {
        "description": "Breakout through resistance with volume (2h)",
        "timeframe": "2h",
        "category": "breakout",
        "applicable_trends": ["BULLISH", "SIDEWAYS"],
        "applicable_volatility": ["NORMAL", "COMPRESSED"],
        "required_structure": ["NEAR_RESISTANCE"],
        "excluded_structure": [],
        "conditions": [
            {"block": "close_above_sma", "params": [50]},
            {"block": "volume_surge",    "params": [1.2]},
    ...
    "2H_SUPPORT_BOUNCE": {
        "description": "Bounce from support with momentum shift (2h)",
        "category": "mean_reversion",
        "applicable_trends": ["SIDEWAYS", "BEARISH"],
        "applicable_volatility": ["NORMAL", "VOLATILE"],
        "required_structure": ["NEAR_SUPPORT"],
        "excluded_structure": [],
        "timeframe": "2h",
        "conditions": [
            {"block": "rsi_below",       "params": [40]},
            {"block": "bullish_candle",  "params": []},
            {"block": "close_above_ema", "params": [12]},
        ],
        "stop_atr_mult": 1.5,
    ...
    "2H_SIDEWAYS_VOLATILE_BREAKOUT": {
        "description": "Breakout from volatile sideways range (2h)",
        "category": "breakout",
        "applicable_trends": ["SIDEWAYS"],
        "applicable_volatility": ["VOLATILE"],
        "excluded_structure": [],
        "timeframe": "2h",
        "conditions": [
            {"block": "close_above_sma",           "params": [50]},
    ...
    "2H_SIDEWAYS_VOLATILE_ACCUMULATION": {
        "description": "Accumulation in volatile sideways with volume confirmation (2h)",
        "category": "momentum",
        "applicable_trends": ["SIDEWAYS"],
        "applicable_volatility": ["VOLATILE"],
        "excluded_structure": [],
    ...
    "SUPPORT_BOUNCE_MOMENTUM": {
        "description": "Momentum bounce from support with trend shift",
        "category": "mean_reversion",
        "applicable_trends": ["SIDEWAYS", "BEARISH"],
        "applicable_volatility": ["NORMAL", "VOLATILE", "COMPRESSED"],
        "required_structure": ["NEAR_SUPPORT"],
        "excluded_structure": [],
        "timeframe": "1d",
        "conditions": [
